...
class ChromeAuto:
    def __init__(self):
        self.driver_path = 'AQUI VEM O CAMINHO DO CHROMEDRIVER'
    ...
    def faz_login(self):
        try:
            ...
            input_login.send_keys('AQUI VEM O USUÁRIO')
            input_password.send_keys('AQUI VEM A SENHA')
            sleep(3)
            btn_login.click()
...
if __name__ == "__main__":
    ...
    chrome.verifica_usuario('USUÁRIO PARA TESTAR AUTENTICAÇÃO')
    sleep(3)
